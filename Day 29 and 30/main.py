...
def save_password():
    ...
    if len(website) == 0 or len(password) == 0:
        ...
        if messagebox.askokcancel(title=website, message=f"Email: {email} \nPassword: {password} \n\nPress OK to save."):
            ...
            except (FileNotFoundError, json.decoder.JSONDecodeError): # file doesn't exist or empty (except Exception)
...
#buttons
search_button = Button(text="Search", width=10, font=FONT, cursor='hand2', command=search_password)
